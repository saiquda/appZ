...
namespace appZ.Controllers
{
    ...
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(AppZContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CountryId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CountryId")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
